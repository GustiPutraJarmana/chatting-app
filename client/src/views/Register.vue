...
<div>
  <div class="container" v-if="!loading">
    <div class="login" >
      ...
      <input type="text" placeholder="username" id="username" v-model="input_username"/>
      ...
      <router-link class="forgot" to="/chat/login">back to login</router-link>
...
input[type="submit"]:active {
  top:3px;
  box-shadow: inset 0px 2px 0px #2ab7ec, 0px 2px 0px 0px #31524d, 0px 5px 3px #999;
